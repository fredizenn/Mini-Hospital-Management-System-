...
export default function Nurses() {
  ...
  const columns = [
    ...
    {field: 'nurseCode', headerName: 'Nurse Code', width: 160},
              ...
              renderCell: (params) => {
                return(
                  ...
                  <button className="ostaffListEdit">Edit</button>
                      ...
                      <DeleteOutline className="ostaffListDelete" onClick={() => handleDelete(params.row.nurseId)}/>
                  </>
                );
              }
            }
    ...
    useEffect(() => {
      fetch("http://localhost:51955/api/nurses/getNurses").then((data) => data.json())
    ...
    return (
        <div className='staffList' style={{height: 500}}>
          ...
          <br/><span className='subHeading'>Registered Nurses</span></div>
          ...
          <div className='button-right'>
            <Link to="/newNurse" className='btn-link'>
