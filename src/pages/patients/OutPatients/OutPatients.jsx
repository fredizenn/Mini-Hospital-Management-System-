...
export default function OutPatients() {
  ...
  const columns = [
    ...
    useEffect(() => {
      fetch("http://localhost:51955/api/patients/getOutPatients").then((data) => data.json())
    ...
    return (
        <div className='staffList' style={{height: 500}}>
          <div className='listHeading'>OUT-PATIENTS
          <br/><span className='subHeading'>All Out-Patients</span>
